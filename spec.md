...
- **Push sur `main`** : dès que le workflow **CI** de ce push est **vert** (`workflow_run`). Pas de CD sur `feature/**` ni sur un CI rouge. Message `[skip cd]` pour pousser sans déployer.
